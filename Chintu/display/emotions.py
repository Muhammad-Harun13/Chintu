...
EMOTION_PROFILES: dict[Emotion, EmotionProfile] = {
    ...
    Emotion.CURIOUS: EmotionProfile(1.05, 1.0, 0.3, 2.0, 4.0, -0.15, tilt_l=-0.4, tilt_r=-0.15, squash_x=1.2, brow_y=-8, mouth_width=0.2, mouth_curve=0.15),
    ...
    Emotion.SCANNING: EmotionProfile(1.0, 0.95, 0.3, 2.8, 5.0, -0.1, tilt_l=0.05, tilt_r=-0.05, squash_y=0.75, brow_y=4, mouth_width=0.4, mouth_curve=0.0),
